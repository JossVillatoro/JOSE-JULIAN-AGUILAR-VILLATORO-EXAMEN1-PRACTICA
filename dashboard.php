...
<form action="dashboard.php" method="GET">
    <div class="formpanel" id="f1">
		...
		<button type="button" class="btn btn-primary" title="Refresca la pagina"><a href="dashboard.php" tittle="refresca la pagina"> <img src='iconoactualizar.png' width='24' height='24'></a></button>
...
<?php
	...
	while($fila = mysqli_fetch_row($resultado)){
		...
		echo "<tr>";
			...
			echo "<td><a href='#' class='btnEditar' data-id='".$fila[0]."' data-bs-toggle='modal' data-bs-target='#modalEditar'><img src='iconoeditar.png' width='20' height='20'></a></td>";
